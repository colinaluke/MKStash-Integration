                    ...
                    <div className="row " >
                        ...
                        <div className="col position-relative">
                            <div className="position-absolute top-50 end-0 translate-middle-y">
                                ...
                                <button className={`isShown ? 'input-group-text' : '', ${styles["searchb"]}`} style={{ backgroundColor: isShown ? 'rgb(208, 61, 71)' : '', color: isShown ? '#FFFFFF !important' : '' }}> <i onClick={handleClick} className={`bi bi-search ${styles["icons"]}`} style={{color: isShown ? 'white' : '' }}> </i></button>
                                <a href="">
