...
const Header = ({ handleLeftNavigation, leftNavBarMustPersist }) => {
    ...
    return (
        <nav id="nav" className={`navbar navbar-expand-lg navbar-dark bg-primary fixed-top ${styles['content']}`} style={{ "transition": "margin-left 0.5s", "marginLeft": leftNavBarMustPersist ? "250px" : "0px" }}>
